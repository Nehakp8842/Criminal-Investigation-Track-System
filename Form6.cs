...
namespace WindowsFormsApp1
{
    public partial class Form6 : Form
    {
        ...
        {
            SqlConnection
                con = new SqlConnection("Data Source=Visual-Program\\NKSQL;Initial Catalog=vbmultiuser;Integrated Security=True");
            con.Open();
            ...
            SqlCommand cmd = new SqlCommand("INSERT INTO CaseToOfficer " + "( case_id, case_name, officer_id, officer_name)" + "VALUES(@a,@b,@c,@d)", con);
